...
function FeedbackForm() {
  ...
  return (
    <section className="text-gray-600 body-font relative">
      <div className="max-w-7xl px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          ...
          className="lg:w-[40%] md:w-1/2 border px-12 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0"
        >
